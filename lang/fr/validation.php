...
return [
    ...
    */
    ...
    'prohibited_unless' => 'Le champ :attribute est interdit à moins que :other est à :value.',
    ...
    */
    ...
    'custom' => [
        ...
        'line_items.*.quantity' => [
            ...
            'min' => 'La quantité doit être au moins de :min.',
        ],
        'line_items.*.unit_price' => [
            'required' => 'Le prix unitaire est obligatoire.',
            'min' => 'Le prix unitaire doit être positif.',
        ],
        'line_items.*.vat_rate' => [
